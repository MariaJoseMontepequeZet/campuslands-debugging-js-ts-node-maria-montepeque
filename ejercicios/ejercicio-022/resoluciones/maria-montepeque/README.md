...
(`../resoluciones/maria-montepeque/welding.ts`), ejecutando `vitest run` contra esa copia
y luego eliminandola (no se dejo ningun archivo extra fuera de esta carpeta).
