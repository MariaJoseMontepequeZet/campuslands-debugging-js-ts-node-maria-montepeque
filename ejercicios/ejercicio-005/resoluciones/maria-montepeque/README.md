...
El `README.md` base describe el objetivo como "validar kilometraje y mantenimientos
vencidos" (tema motos en taller), pero el archivo real `codigo/moto-service.js` y su
test `tests/moto-service.test.js` no contienen logica de kilometraje ni mantenimientos:
son el mismo contrato de `calcularResultado` (suma de puntos) y `ordenarRanking` (orden
de mayor a menor) que los ejercicios 001 a 004. Se corrigio el codigo tal como existe
...
import { calcularResultado, ordenarRanking } from './ejercicios/ejercicio-005/resoluciones/maria-montepeque/moto-service.js';
