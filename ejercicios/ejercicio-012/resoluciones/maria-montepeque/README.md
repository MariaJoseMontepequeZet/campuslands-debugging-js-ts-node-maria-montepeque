...
El `README.md` base describe el objetivo como "calcular ganador por tarjetas de jueces"
(tema kickboxing, dificultad "Basico retador"), pero el archivo real
`codigo/kickboxing.js` y su test `tests/kickboxing.test.js` no contienen logica de
tarjetas de jueces: son el mismo contrato de `calcularResultado` (suma de puntos) y
`ordenarRanking` (orden de mayor a menor) que los ejercicios 001 a 011. Se corrigio el
...
import { calcularResultado, ordenarRanking } from './ejercicios/ejercicio-012/resoluciones/maria-montepeque/kickboxing.js';
