# Ejercicio 007: Peliculas de miedo

## Nota sobre el ejercicio

El `README.md` base describe el objetivo como "contar votos y empates correctamente"
(tema peliculas de miedo), pero el archivo real `codigo/horror-awards.js` y su test
`tests/horror-awards.test.js` no contienen logica de votos ni empates: son el mismo
contrato de `calcularResultado` (suma de puntos) y `ordenarRanking` (orden de mayor a
menor) que los ejercicios 001 a 006. Se corrigio el codigo tal como existe realmente,
...
import { calcularResultado, ordenarRanking } from './ejercicios/ejercicio-007/resoluciones/maria-montepeque/horror-awards.js';
