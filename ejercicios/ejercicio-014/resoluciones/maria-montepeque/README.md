...
El `README.md` base describe el objetivo como "validar agenda y duracion de sesiones"
(tema tatuajes, dificultad "Basico retador"), pero el archivo real
`codigo/tattoo-agenda.js` y su test `tests/tattoo-agenda.test.js` no contienen logica de
agenda ni duracion de sesiones: son el mismo contrato de `calcularResultado` (suma de
puntos) y `ordenarRanking` (orden de mayor a menor) que los ejercicios 001 a 013. Se
...
import { calcularResultado, ordenarRanking } from './ejercicios/ejercicio-014/resoluciones/maria-montepeque/tattoo-agenda.js';
