...
El `README.md` base describe el objetivo como "convertir unidades de velocidad
correctamente" (tema autos hiperdeportivos), pero el archivo real `codigo/hypercar.js`
y su test `tests/hypercar.test.js` no contienen logica de conversion de unidades: son
el mismo contrato de `calcularResultado` (suma de puntos) y `ordenarRanking` (orden de
mayor a menor) que los ejercicios 001 a 008. Se corrigio el codigo tal como existe
...
import { calcularResultado, ordenarRanking } from './ejercicios/ejercicio-009/resoluciones/maria-montepeque/hypercar.js';
